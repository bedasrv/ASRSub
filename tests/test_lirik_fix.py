...
class TestAsrGuardSkip(unittest.TestCase):
    def _run_process_after_asr(self, asr_lang, expected_skip):
        ...
        def fake_translate_texts(cfg_, cues_, target_lang, key, series_id=None, episode_id=None, prior_cache=None, series_title=None, skip_guard=False, source_lang="Japanese", **kwargs):
