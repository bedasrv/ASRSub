...
- Rust coverage **at the time of the port**: 72 unit `#[test]` (incl. the
  ...
  grown since: 117 unit tests + 4 integration tests (`cargo test`; `README.md`
  quotes the same pair) and 54 release-contract cases (`python3 -m unittest
